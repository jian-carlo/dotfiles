	...
	config = function()
		...
		require("gruvbox").setup({
			...
			overrides = {
				...
				markdownMathDelimiter = { fg = palette.gray },
				markdownBlockMathDelimiter = { fg = palette.gray },
				markdownInlineMath = { fg = palette.faded_blue },
				markdownBlockMath = { fg = palette.faded_blue },
				markdownError = { bg = "#181616" },
				markdownMathLabel = { fg = palette.faded_aqua },
				...
				["@markup.list.markdown"] = { fg = palette.gray },
				["@markup.link.markdown_inline"] = { fg = palette.faded_orange },
				["@markup.link.label.markdown_inline"] = { fg = palette.faded_orange },
				["@string.escape.markdown_inline"] = { fg = palette.faded_blue },
				...
				texSICmd = { fg = nil },
				texSIArgUnit = { fg = palette.bright_blue },
				...
				texMathSuper = { fg = palette.bright_blue },
