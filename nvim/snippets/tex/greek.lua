...
return {
	...
	s({ trig = "@e", name = "epsilon", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("epsilon")),
	s({ trig = "@ve", name = "varepsilon", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("varepsilon")),
	s({ trig = "@z", name = "zeta", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("zeta")),
	s({ trig = "\\epsilont", name = "eta", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("eta")),
	s({ trig = "\\tauh", name = "theta", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("theta")),
	...
	s({ trig = "@o", name = "omicron", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("omicron")),
	...
	s({ trig = "\\omicronm", name = "omega", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("omega")),
	...
	s({ trig = "\\Tauh", name = "Theta", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("Theta")),
	s({ trig = "@I", name = "Iota", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("Iota")),
	s({ trig = "@K", name = "Kappa", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("Kappa")),
	s({ trig = "@L", name = "Lambda", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("Lambda")),
	s({ trig = "@M", name = "Mu", snippetType = "autosnippet", wordTrig = false }, greek_letter_snippet("Mu")),
